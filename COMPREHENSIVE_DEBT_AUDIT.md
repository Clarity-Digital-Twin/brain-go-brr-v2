...
We enforced the zero-debt policy *before* spending ~$319 on the Modal A100 run. All previously identified P2/P3 items are closed, documentation matches reality, and the codebase is pristine for the 100-epoch training campaign.
