...
- `evaluate` command (~223 lines) currently orchestrates option parsing, checkpoint resolution, dataset construction, model loading, inference, metric computation, and export in a single function.
