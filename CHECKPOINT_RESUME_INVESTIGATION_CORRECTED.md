...
**Status**: Investigation corrected. Real bugs identified. Original diagnosis was flawed but led to finding actual issues.
**Credit**: External AI Agent for catching the errors and forcing rigorous first-principles analysis.
