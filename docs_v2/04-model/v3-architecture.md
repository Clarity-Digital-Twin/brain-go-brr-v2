# V3 Architecture (v3.4.1 - Single Source of Truth)

**Last Updated**: October 1, 2025
**Current Version**: v3.4.1
**Status**: VALIDATED - Rock solid training (batch 723+, zero NaN/Inf)
...
- **Stability evolution**: `docs_v2/RECENT-WORK-SYNTHESIZED/01-nan-and-stability/ARCHITECTURE_V3_STABILITY.md`
- **Warmup schedules**: `docs_v2/RECENT-WORK-SYNTHESIZED/02-warmup-schedules/WARMUP_SCHEDULES_GUIDE.md`
