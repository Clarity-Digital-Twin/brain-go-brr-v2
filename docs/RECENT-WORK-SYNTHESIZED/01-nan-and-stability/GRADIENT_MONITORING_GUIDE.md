...
- See troubleshooting guide in `NAN_PREVENTION_COMPLETE.md`
...
└─ NO  → Are you seeing NaN losses?
         ├─ YES → 🚨 Check NAN_PREVENTION_COMPLETE.md
...
**Related Docs**:
- `NAN_PREVENTION_COMPLETE.md` - Troubleshooting NaN issues
- `ARCHITECTURE_V3_STABILITY.md` - Eigendecomposition fix details
- `WARMUP_SCHEDULES_GUIDE.md` - Warmup schedule configuration
